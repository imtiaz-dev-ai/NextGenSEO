...
const WhatsAppButton: React.FC = () => (
  <a
    ...
    className="fixed bottom-24 sm:bottom-28 right-4 sm:right-8 z-[70] w-12 h-12 sm:w-14 sm:h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-2xl whatsapp-pulse transition-all hover:scale-110 tooltip"
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 sm:bottom-8 right-4 sm:right-8 z-[70] w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white shadow-2xl shadow-purple-500/40 btn-3d animate-pulse-ring"
      >
        {showChat ? (
