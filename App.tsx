  ...
  <div className="pt-24 pb-20 px-4 sm:px-6 max-w-7xl mx-auto">
    ...
    <div className="mb-10 sm:mb-16">
        ...
        <div className="flex gap-2 mt-2">
          {[{ href: 'https://www.linkedin.com/company/nextgenseo-official/', label: 'LinkedIn', hover: 'hover:bg-blue-600', path: 'M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z' },
            ...
            <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 ${social.hover} transition-all flex items-center justify-center`}>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-10 sm:mb-16">
      <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border-purple-500/20 hover-lift">
        ...
        <h3 className="text-lg sm:text-xl font-black mb-2">Our Vision</h3>
        <p className="text-sm text-slate-400 leading-relaxed">To become the best SEO agency by delivering affordable, transparent, and results-driven SEO services that empower small businesses to dominate Google search results.</p>
      </div>
      <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border-amber-500/20 hover-lift">
        ...
        <h3 className="text-lg sm:text-xl font-black mb-2">Our Promise</h3>
        <p className="text-sm text-slate-400 leading-relaxed">Affordable SEO packages with complete transparency in reporting and a relentless focus on ROI. We don't just improve rankings—we help your business grow.</p>
      </div>
      <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border-emerald-500/20 hover-lift">
    ...
    <div className="mb-10 sm:mb-16">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
        ...
        <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl hover-lift">
          <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-4 sm:mb-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl font-black mb-3 sm:mb-4">Expert Team</h3>
          <p className="text-sm sm:text-base text-slate-400">SEO experts, link building specialists, and content marketers working together to boost your Google rankings.</p>
        </div>
        <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl hover-lift">
          <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-4 sm:mb-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center">
            <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-6">
            ...
            <div className="glass p-5 sm:p-8 rounded-2xl sm:rounded-3xl border-amber-500/20 hover-lift group">
              ...
              <a href="tel:+923480440402" className="text-amber-400 font-bold hover:text-amber-300 transition-colors flex items-center gap-2 mb-3">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
